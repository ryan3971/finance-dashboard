...
import { AmexAdapter } from './adapters/amex.adapter';
import { CibcAdapter } from './adapters/cibc.adapter';
import { TdAdapter } from './adapters/td.adapter';
import { QuestradeAdapter } from './adapters/questrade.adapter';
...
export function getAdapterByInstitution(institution: string): CsvAdapter | null {
